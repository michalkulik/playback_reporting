...
namespace Jellyfin.Plugin.PlaybackReporting.Data
{
    public sealed class ActivityRepository
    {
        ...
        private SQLiteDatabaseConnection connection = null;
        ...
        private SQLiteDatabaseConnection CreateConnection(string db_file)
        {
            ...
            SQLiteDatabaseConnection db = SQLite3.Open(db_file, connectionFlags, null);
